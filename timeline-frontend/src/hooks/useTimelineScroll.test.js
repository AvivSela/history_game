...
describe('useTimelineScroll', () => {
  ...
  it('should provide a ref', () => {
    const { result } = renderHook(() => useTimelineScroll({ scrollAmount: 200 }));
  ...
  it('should scroll left by scrollAmount', () => {
    ...
    expect(timeline.scrollTo).toHaveBeenCalledWith({ left: -100, behavior: 'smooth' });
  ...
  it('should scroll right by scrollAmount', () => {
    ...
    expect(timeline.scrollTo).toHaveBeenCalledWith({ left: 300, behavior: 'smooth' });
  ...
  it('should scroll to end (scrollWidth)', () => {
    ...
    expect(timeline.scrollTo).toHaveBeenCalledWith({ left: 1000, behavior: 'smooth' });
