...
export const UI_DIMENSIONS = {
  ...
  TIMELINE_INSERTION_POINT_CIRCLE_SIZE: 48, // w-12 h-12
  TIMELINE_TOOLTIP_OFFSET: 48, // -top-12
  TIMELINE_CONTAINER_PADDING: 24, // p-6
  TIMELINE_CONTAINER_MARGIN: 20, // my-5
  TIMELINE_CONTENT_PADDING: 24, // py-6
  TIMELINE_EMPTY_STATE_PADDING: 64, // py-16
  TIMELINE_EMPTY_STATE_INNER_PADDING: 32, // p-8
  TIMELINE_EMPTY_STATE_ICON_SIZE: 96, // text-6xl
  TIMELINE_EMPTY_STATE_TITLE_SIZE: 20, // text-xl
  TIMELINE_EMPTY_STATE_ICON_MARGIN: 16, // mb-4
  TIMELINE_EMPTY_STATE_TITLE_MARGIN: 8, // mb-2
  TIMELINE_ITEMS_GAP: 24, // gap-6
  TIMELINE_CARD_WRAPPER_GAP: 12, // gap-3
  TIMELINE_DATE_CONTAINER_GAP: 6, // gap-1.5
  TIMELINE_DATE_CONTAINER_MARGIN: 6, // mb-1.5
  TIMELINE_DATE_CONTAINER_PADDING: 12, // px-3 py-2
  TIMELINE_DATE_CONTAINER_MIN_WIDTH: 80, // min-w-[80px]
  TIMELINE_YEAR_TEXT_SIZE: 16, // text-base
  TIMELINE_DATE_TEXT_SIZE: 12, // text-xs
  TIMELINE_DATE_TEXT_MARGIN: 2, // mt-0.5
  TIMELINE_SCROLL_CONTROLS_OFFSET: 8, // left-2 right-2
  TIMELINE_SCROLL_BUTTON_SIZE: 40, // w-10 h-10
  TIMELINE_SCROLL_BUTTON_TEXT_SIZE: 20, // text-xl
  TIMELINE_INSERTION_POINT_PADDING: 16, // p-4
  TIMELINE_INSERTION_POINT_MARGIN: 16, // -m-4
  TIMELINE_TOOLTIP_PADDING: 8, // px-2 py-1
  TIMELINE_TOOLTIP_TEXT_SIZE: 12, // text-xs
  TIMELINE_ICON_SIZE: 18, // text-lg
