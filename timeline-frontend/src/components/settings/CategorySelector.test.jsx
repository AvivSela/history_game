...
describe('CategorySelector', () => {
  const defaultProps = {
    ...
    categories: [
      ...
      },
      {
        id: 'art',
        name: 'Art',
        description: 'Artistic movements and masterpieces',
      },
      {
        id: 'literature',
        name: 'Literature',
      ...
      },
      {
        id: 'geography',
        name: 'Geography',
        description: 'Places, countries, and landmarks',
      },
    ],
  };
  ...
  describe('Rendering', () => {
    ...
    test('renders category descriptions', () => {
      ...
      expect(
        screen.getByText('Historical events and figures')
      ).toBeInTheDocument();
      expect(
        screen.getByText('Scientific discoveries and inventions')
      ).toBeInTheDocument();
    });
    ...
    test('renders with custom className', () => {
      ...
      const container = screen
        .getByText('Game Categories')
        .closest('.category-selector');
    ...
    test('renders favorites section', () => {
      ...
      const favoriteButton = historyCheckbox
        .closest('.category-selector__item')
        .querySelector('.category-selector__favorite');
  ...
  describe('User Interactions', () => {
    ...
    test('updates selection when value prop changes', () => {
      ...
      rerender(
        <CategorySelector {...defaultProps} value={['art', 'literature']} />
      );
  ...
  describe('Search Functionality', () => {
    ...
    test('shows no results message when no matches', () => {
      ...
      expect(
        screen.getByText(/No categories found matching/)
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Edge Cases', () => {
    ...
    test('handles invalid value gracefully', () => {
      render(
        <CategorySelector {...defaultProps} value={['invalid-category']} />
      );

      // Open dropdown first
      const triggerButton = screen.getByRole('button', {
        name: /1 category selected/i,
      });
      fireEvent.click(triggerButton);
