  ...
  (
    ...
    const debouncedAnimateCard = useCallback(
      async (cardId, animationType) => {
        ...
        try {
          ...
          animationRefs.current.set(cardId, {
            element: cardElement,
            type: animationType,
          });
    ...
    const getCardStyle = index => {
      ...
      return {
        transform,
        zIndex: isSelected
          ? UI_DIMENSIONS.Z_INDEX.SELECTED_CARD
          : isHovered
            ? UI_DIMENSIONS.Z_INDEX.HOVERED_CARD
            : position.zIndex,
      ...
      return (
        ...
        >
          ...
          <div className="text-center py-12">
            <div
              className="bg-gradient-to-br from-success/10 to-success/5 rounded-lg p-8 border border-success/20"
              data-testid="hand-victory-message"
            >
              ...
              <p className="text-text-light mb-4">
                Congratulations! You've placed all your cards on the timeline.
              </p>
        ...
        <div className="flex justify-between items-start mb-4 pb-3 border-b-2 border-border lg:mb-5 lg:pb-4">
          <div className="player-info">
            ...
            <div className="text-xs font-semibold uppercase tracking-wider">
              {isPlayerTurn ? (
                <span className="text-success bg-success/10 px-2 py-1 rounded-xl border border-success/30">
                  Your Turn
                </span>
              ) : (
                <span className="text-text-light bg-background px-2 py-1 rounded-xl border border-border">
                  Waiting...
                </span>
              )}
            </div>
            ...
            {cards.map((card, index) => {
              ...
              return (
                <div
                  ...
                  {...(isSelected
                    ? { 'data-testid': 'hand-selected-card' }
                    : {})}
                >
                  <Card
                    event={card}
          ...
          <div className="mt-4 text-center">
            <div className="w-full h-2 bg-border rounded overflow-hidden mb-2">
              <div
                ...
                style={{
                  width: `${((maxCards - cards.length) / maxCards) * 100}%`,
                }}
              ></div>
            </div>
        ...
        <div className="bg-background rounded-lg p-4 border border-border">
          {selectedCard ? (
            <div className="flex flex-col gap-4">
              <div>
                <h4 className="m-0 mb-2 text-primary text-base">
                  Selected: {selectedCard.title}
                </h4>
                <p className="m-0 text-text-light text-sm italic">
                  Click on the timeline to place this card
                </p>
              </div>
            ...
            <div className="text-center">
              {isPlayerTurn ? (
                <div>
                  <h4 className="m-0 mb-3 text-primary text-base">
                    How to play:
                  </h4>
