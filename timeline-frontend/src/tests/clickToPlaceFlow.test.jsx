...
describe('Click-to-Place Flow Integration', () => {
  describe('Complete Game Flow', () => {
    it('should complete full click-to-select and click-to-place cycle', async () => {
      ...
      expect(
        screen.getByText(/Correct.*Berlin Wall Falls placed successfully/)
      ).toBeInTheDocument();
    ...
    it('should handle incorrect placement and allow retry', async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/Incorrect.*Try again with Berlin Wall Falls/)
        ).toBeInTheDocument();
      });
      expect(
        screen.getByText('Selected: Berlin Wall Falls')
    ...
    it('should handle selecting different cards', () => {
      ...
      const secondCard = screen
        .getByText('World War II Begins')
        .closest('.player-card');
      fireEvent.click(secondCard);
      expect(
        screen.getByText('Selected: World War II Begins')
      ).toBeInTheDocument();
      expect(
        screen.queryByText('Selected: Berlin Wall Falls')
      ).not.toBeInTheDocument();
