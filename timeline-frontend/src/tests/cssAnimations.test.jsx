...
describe('CSS Animations', () => {
  ...
  describe('Animation Classes', () => {
    ...
    it('should apply card-wrong-placement animation class', () => {
      ...
      expect(testElement.classList.contains('card-wrong-placement')).toBe(
        false
      );
    });
    ...
    it('should apply timeline-wrong-placement animation class', () => {
      ...
      expect(testElement.classList.contains('timeline-wrong-placement')).toBe(
        true
      );
    ...
    it('should apply insertion-point-error animation class', () => {
      ...
      expect(testElement.classList.contains('insertion-point-error')).toBe(
        true
      );
